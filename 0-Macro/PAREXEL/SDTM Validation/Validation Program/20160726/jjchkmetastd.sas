...
%libm(meta=datadef, cond=%str(a.DATASET=b.DATASET),label=Dataset Level Metadata, id=DATASET notsorted, dv=KEYS)
...
ods listing close;
ods tagsets.excelxp file="&_tglobal.Metadata.xml" style = XLsansPrinter
