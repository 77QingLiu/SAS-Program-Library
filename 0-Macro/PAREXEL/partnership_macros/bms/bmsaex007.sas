...
-------------------------------------------------------------------------------
  ...
  Program Location/Name: $HeadURL: http://kennet.na.pxl.int:7070/svnrepo/LP_BLINDED_GLOBALMACROLIBARY_STATS/partnership_macros/bms/bmsaex007.sas $

  Files Created:         N/A

  Program Purpose:       Produce the output dataset for Adverse Event tables based on GS_AE_T_X_007
  ...
  Macro Parameters:
    ...
    Name:                dataIn
      ...
      Description:       The name of the input dataset.
                         The default value can be reassigned in setup using variable BMS_AE_DATAIN.
    ...
    Name:                trtNum
      Description:       The string in the following format:
                         ...
                         #See discussions for more details.
                         #The default value can be reassigned in setup using variable BMS_AE_TRTNUM.
      Default Value:     trtan
    ...
    Name:                trtName
      Description:       The string in the following format:
                         ...
                         input dataset.
                         #See discussions for more details.
                         #The default value can be reassigned in setup using variable BMS_AE_TRTNAME.
      Default Value:     trta

    Name:                aeBodSys
      Default Value:     aeBodSys
      Description:       The name of the variable of System Organ Class.
                         The default value can be reassigned in setup using variable BMS_AE_AEBODSYS.

    Name:                aeDecod
      Default Value:     aeDecod
      Description:       The name of the variable of Preferred Term.
                         The default value can be reassigned in setup using variable BMS_AE_AEDECOD.

    Name:                aeToxGrN
      Default Value:     aeToxGrN
      Description:       The name of the variable of CTC Toxicity Grade.
                         The default value can be reassigned in setup using variable BMS_AE_AETOXGRN.

    Name:                popIn
      Default Value:     analysis.adsl
      Description:       The name of the dataset for population counts.
                         The default value can be reassigned in setup using variable BMS_AE_POPIN.

    Name:                popTrtNum
      Default Value:     trt01an
      Description:       The name of numeric treatment variable in the population dataset.
                         The default value can be reassigned in setup using variable BMS_AE_POPTRTNUM.

    Name:                popTrtName
      Default Value:     trt01a
      Description:       The name of character treatment variable in the population dataset.
                         The default value can be reassigned in setup using variable BMS_AE_POPTRTNAME.
    ...
    Name:                popFlag
      ...
      Description:       The condition to be used for calculation the population for the analysis.
                         ...
                         The default value can be reassigned in setup using variable BMS_AE_POPFLAG.

    Name:                subjidVar
      Default Value:     usubjid
      Description:       The variable containing the subject ID.
                         The default value can be reassigned in setup using variable BMS_AE_SUBJIDVAR.
...
%macro bmsaex007(dataOut=, where=, cutPct=,
                varsBy=, TotalStr="TOTAL SUBJECTS WITH AN EVENT",
                sortSOC=FREQ, sortPT=FREQ,
                dataIn=, trtNum=, trtName=, aebodsys=, aedecod=,  aetoxgrn=,
                SubjidVar=, PopIn=, PopTrtNum=, PopTrtName=, PopFlag=,
                putLen=4, termColWidth= , resultColWidth=,
                subgroup=, subgroupn=, selectType=E);

  %gmStart( headURL  = $HeadURL: http://kennet.na.pxl.int:7070/svnrepo/LP_BLINDED_GLOBALMACROLIBARY_STATS/partnership_macros/bms/bmsaex007.sas $
          , revision = $Rev: 1874 $
    ...
    %let codeFile = %quote(bmsaex007.sas);
    ...
    %else %do;
        ...
        %if &cutPct ne %then %do;
            %bmsAeCutOff(dataIn=&ds.0, dataOut=&ds.cut, cutValue=&cutPct, varsby = &varsby.,
                         cutVarList = _freq_p_&aedecod._total, terms = 2);
    ...
    proc sort data = &dataOut;
        by &varsby. grpxSort1 grpxSort2 grpxSort3;
    run;
