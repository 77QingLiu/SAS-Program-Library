...
-------------------------------------------------------------------------------
  ...
  Program Location/name: $HeadURL: http://kennet.na.pxl.int:7070/svnrepo/LP_BLINDED_JANSS229288_STATS/transfer/qcprog/transfer/qc_ti.sas $

  Files Created:         qc_ti.log
                         ti.sas7bdat

  Program Purpose:       To QC Trial Inclusion/Exclusion Criterion Dataset
