...
-------------------------------------------------------------------------------
  ...
  Creation Date:         16Apr2015/ $LastChangedDate: 2016-08-29 03:54:05 -0400 (Mon, 29 Aug 2016) $

  Program Location/name: $HeadURL: http://kennet.na.pxl.int:7070/svnrepo/LP_BLINDED_JANSS229288_STATS/transfer/qcprog/macros/jjqccmcoding.sas $

  Files Created:         jjqccmcoding.log
...
length CMLVL1-CMLVL4 &PRETXT_._ATC2 CMDECOD CMBASPRF CMTRDCD CMTRD $200. CMLVL1CD CMLVL2CD CMLVL3CD CMLVL4CD &PRETXT_._ATC_CODE_ $8.;
CODER_HIERARCHY_ = CODER_HIERARCHY;
  ...
  call missing(CMDECOD,CMTRT_ATC,CMTRT_ATC_CODE,CMLVL4,CMLVL3,CMLVL2,CMLVL1,CMLVL4CD,CMLVL3CD,CMLVL2CD,CMLVL1CD,CMBASPRF,CMTRDCD,CMTRD);
    do k = 1 to 4;
    /*
      if strip(&pretxt_._RXPREF_CODE) = strip(CMLVLCD_(k,5)) and
         strip(&pretxt_._TRADE_NAME_CODE)  = strip(CMLVLCD_(k,6)) then
      do;
    */
