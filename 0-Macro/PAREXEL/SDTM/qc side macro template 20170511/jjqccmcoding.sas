/*-----------------------------------------------------------------------------
  ...
  Sponsor / Protocol No: Janssen Research & Development / 54767414MMY3008
  PXL Study Code:        219155

  SAS Version:           9.3
  Operating System:      UNIX
-------------------------------------------------------------------------------

  Author:                Qingjie Zeng $LastChangedBy: $
  Creation Date:         16-Apr-2015/ $LastChangedDate: $
