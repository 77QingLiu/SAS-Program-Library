...
%macro pfesacq_pk_recon_a_checks_report();
    %put ---------------------------------------------------------------------;
    %put NOTE:[PXL] PFESACQ_PK_RECON_A_CHECKS_REPORT: Start of Submacro;
    %put ---------------------------------------------------------------------;
    %put ;

	options ls=256 ps=64 nocenter; 

	%if %sysfunc(exist(unblind.pkchecka)) %then %do;
	...
	*footnote1 j=l "&sysdate9.";
	...
	ODS TAGSETS.EXCELXP
	file="&path_listings./current/&protocol._Analytical PK Checks_&rundate..xls"
	STYLE=Printer
	OPTIONS ( 
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
                                          style(column)=[fontsize=8pt];

		column  /*status*/ flag study siteid subjid visit analyte;
		where flagn in (1);
		...
		*define	status    / "Data State"           display flow style(header) = {background=grey  foreground=black}; 
		...
		define	analyte   / "Analyte Name"         display flow style(header) = {background=grey  foreground=black};
	...
	data zero_obs_ds;
		...
		/*status='No output for this listing';*/ flag='Invalid Study ID'; study=''; siteid='';subjid=''; visit='';analyte='';
		label /*status='Data State'*/ flag='Flag' study='Study' subjid='Subject' siteid='Site'  visit='Visit' analyte='Analyte Name';
	...
	********************;
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study siteid source subjid visit analyte pktpt pksmpid;
		where flagn=2;
	...
	data zero_obs_ds;
		...
		flag='Missing Subject'; study=''; SITEID='';subjid='';source=''; visit='';pktpt='';pksmpid='';analyte='';
		label flag='Flag' study='Study' siteid='Site' subjid='Subject' visit='Visit'  pktpt='Timepoint' pksmpid='Sample ID' 
              analyte='Analyte' source='Source Data';
	...
	********************;
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study siteid subjid visit analyte pktpt pksmpid;
		where flagn=3;
	...
	data zero_obs_ds;
		...
		flag='Invalid Visit'; study=''; SITEID='';subjid=''; visit='';pktpt='';pksmpid='';analyte='';
		label  flag='Flag' study='Study' siteid='Site' subjid='Subject' visit='Visit'  pktpt='Timepoint' pksmpid='Sample ID' 
	...
	********************;
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study source siteid subjid visit analyte pktpt pksmpid colldate testtime;
		where flagn=4;
	...
	data zero_obs_ds;
		...
		flag='Missing PK Data for Study Visit'; study=''; SITEID='';subjid=''; visit='';pktpt='';pksmpid='';colldate='';testtime='';analyte='';source='';
		label flag='Flag' study='Study' siteid='Site' subjid='Subject' visit='Visit'  pktpt='Timepoint' pksmpid='Sample ID' source='Source Data'
              colldate='Collection Date' testtime='Collection Time' analyte='Analyte Name';
...
/*
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study site subjid visit pktpt pksmpid colldate testtime;
		where flagn=5;
...
*/
	...
	********************;
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study siteid subjid visit analyte pktpt pksmpid acession;
		where flagn=6;
	...
	data zero_obs_ds;
		...
		flag='Duplicate Accession Number Across Subjects'; study=''; SITEID='';subjid=''; visit='';pktpt='';pksmpid='';acession='';analyte='';
	...
	********************;
	...
	data zero_obs_ds;
		...
		flag='Duplicated Record on Vendor'; study=''; SITEID='';subjid=''; visit='';pktpt='';pksmpid='';acession='';analyte='';
		label flag='Flag' study='Study' siteid='Site' subjid='Subject' visit='Visit'  pktpt='Timepoint' pksmpid='Sample ID' acession='Accession Number'
              analyte='Analyte Name';
	...
	********************;
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study siteid subjid visit analyte pktpt pksmpid randnum;
		where flagn=8;
	...
	data zero_obs_ds;
		...
		flag='Duplicate Randomization Number on Vendor'; study=''; siteid='';subjid=''; visit='';pktpt='';pksmpid='';randnum='';analyte='';
		label flag='Flag' study='Study' siteid='Site' subjid='Subject' visit='Visit'  pktpt='Timepoint' pksmpid='Sample ID' 
              analyte='Analyte Name' randnum='Randomization Number';
	...
	********************;
	...
	proc report data=unblind.pkchecka nowd style(header)=[background=grey foreground=black fontweight=bold fontsize=8pt]
		...
		column  flag study source siteid subjid visit analyte pktpt pksmpid;
		where flagn=9;
	...
	data zero_obs_ds;
		...
		flag='Sample ID not Unique'; study=''; siteid='';subjid=''; visit='';pktpt='';pksmpid='';analyte='';source='';
		label flag='Flag' study='Study' siteid='Site' subjid='Subject' visit='Visit'  pktpt='Timepoint' pksmpid='Sample ID' analyte='Analyte Name' source='Source Data';
	...
	*proc print data=zero_obs_ds LABEL noobs;
	...
	%else %do;
    			%put %str(ERR)OR:[PXL]--------------------------------------------------------------------------;
    			%put %str(ERR)OR:[PXL] PFESACQ_PK_RECON_A_CHECKS_REPORT: alert: Dataset PKCHECKA does not exist.;
    			%put %str(ERR)OR:[PXL]--------------------------------------------------------------------------;
		  %end;
    ...
    %put ;
    %put ---------------------------------------------------------------------;
    %put NOTE:[PXL] PFESACQ_PK_RECON_A_CHECKS_REPORT: End of Submacro;
    %put ---------------------------------------------------------------------;
    %put ;

%mend pfesacq_pk_recon_a_checks_report;
