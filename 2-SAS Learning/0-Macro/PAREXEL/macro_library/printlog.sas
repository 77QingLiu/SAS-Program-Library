%MACRO printlog( file=, log=log, append=, Prod=_gProd, prgname=_prgname,
         RET=_NULL_);
...
%******************************************************************************;
%*                                                                             ;
%* PROGRAM NAME:      printlog.sas                                             ;
%*                                                                             ;
%* PROGRAM LOCATION:  /opt/pxlcommon/stats/macros/sas/code/printlog/ver002     ;
%*                                                                             ;
%******************************************************************************;
%*                                                                             ;
