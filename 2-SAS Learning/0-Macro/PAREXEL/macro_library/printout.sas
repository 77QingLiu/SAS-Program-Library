%MACRO printout( file=, txt=txt, append=, Prod=_gProd, prgname=_prgname,
         RET=_NULL_);
...
%******************************************************************************;
%*                                                                             ;
%* PROGRAM NAME:      printout.sas                                             ;
%*                                                                             ;
%* PROGRAM LOCATION:  /opt/pxlcommon/stats/macros/sas/code/printout/ver002     ;
%*                                                                             ;
%******************************************************************************;
%*                                                                             ;
   ...
   %IF &&&Prod=1 %THEN %DO;
      ...
      %ELSE %DO;
         %IF %UPCASE(%QUOTE(&append))=%STR( )  %THEN %DO;
            PROC PRINTTO PRINT = "&file..&txt" NEW;
            RUN;
         %END;
         %ELSE %DO;
