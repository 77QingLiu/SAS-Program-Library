...
/*options ls=&ls ps=&ps;*/
%global sep dev_phase dev_phase2;
** define environment;
...
%if %index(&rpt_name,_v) ge 1 or %index(&rpt_name,v_) ge 1 %then %do;
   fotnot&prp_j="Program Location: &sep.&sep.&dir_root.&sep.&dev_phase.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.replica_programs&sep.&rpt_pgm..&pgm_type";
   fotnot&prp_2j="Output Location: &sep.&sep.&dir_root.&sep.&dev_phase.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.replica_programs&sep.replication_output&sep.&rpt_name..&rpt_type";	
