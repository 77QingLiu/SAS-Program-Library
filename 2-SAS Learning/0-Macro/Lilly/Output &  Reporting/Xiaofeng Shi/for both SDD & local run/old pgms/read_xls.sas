...
/*<process sessionid="-2a5f3551:1422db1cd85:-7c02" sddversion="3.5" cdvoption="N" parseroption="B">*/
/* <parameters>*/
...
/*   <default>*/
/*    <file system="SDD" source="DOMAIN" displaypath="/lillyce/qa/ly2439821/i1f_je_rhat/lums" displayname="_SETUP_intrm1.sas" id="/lillyce/qa/ly2439821/i1f_je_rhat/lums/_SETUP_intrm1.sas" itemtype="Item" type="sas" fileinfoversion="3.0">*/
/*    </file>*/
/*   </default>*/
/*  </parameter>*/
/*  <parameter dependsaction="ENABLE" label="Process parameter values" resolution="INPUT" type="PARMFILE" baseoption="A" processid="P1" id="SDDPARMS" order="24" protect="N" enable="N" filetype="SAS7BDAT" autolaunch="N" canlinktobasepath="Y"*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter dependsaction="ENABLE" label="SAS output" resolution="INPUT" type="LSTFILE" baseoption="A" processid="P1" id="&star;LST&star;" order="25" protect="N" enable="N" filetype="LST" autolaunch="N" canlinktobasepath="Y" userdefined="S"*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter dependsaction="ENABLE" label="SAS log" resolution="INPUT" type="LOGFILE" baseoption="A" processid="P1" id="&star;LOG&star;" order="26" protect="N" enable="N" filetype="LOG" autolaunch="N" canlinktobasepath="Y" userdefined="S"*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter base="BASE_1" obfuscate="N" label="Input file" tabname="Parameters" baseoption="A" advanced="N" order="27" id="EXCEL" canlinktobasepath="Y" writefile="Y" protect="N" filetype="TXT" processid="P1" required="N" enable="N"*/
/*   resolution="INPUT" type="INFILE">*/
/*   <default>*/
/*    <file system="RELATIVE" source="RELATIVE" displaypath="intrm1/data/shared/arc_reporting_metadata" displayname="RHAT_interimDBL_ARCtool_v2.1_20131106.xlsx" id="intrm1/data/shared/arc_reporting_metadata/RHAT_interimDBL_ARCtool_v2.1_20131106.xlsx"*/
