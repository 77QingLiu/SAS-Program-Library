...
%***************************************************************************;
** define environment;
%global os sep ls ps studyid trt1 trt2 trt3 trt4 trt5 drive_root dir_root dev_phase dev_phase2 compound study analy_phase referenc pgm_dir;
...
%let drive_root=d:\lillysdd; /*Drive*/
...
%let pgm_dir=programs_nonsdd;/*program location*/
...
%let ps=47; /*page size*/
filename lum "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\&pgm_dir\author_component_modules";
filename bum "D:\lillysdd\lillyce\prd\general\bums\macro_library";
options mautosource sasautos=(lum,bum,sasautos);
...
%include "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\programs_nonsdd\formats.sas";
...
/*<process sessionid="-1730067e:14234159aa2:7ae3" sddversion="3.5" cdvoption="N" parseroption="B">*/
/* <parameters>*/
/*  <parameter userdefined="B" obfuscate="N" usecdv="N" id="BASE_2" canlinktobasepath="N" cdvenable="N" protect="N" label="Base path for relative paths" order="1" processid="P11" dependsaction="ENABLE" usecdvpath="N" cdvrequired="N" resolution="INPUT"*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter userdefined="B" obfuscate="N" usecdv="N" id="BASE_1" canlinktobasepath="N" cdvenable="N" protect="N" label="Base path for relative paths" order="2" processid="P11" usecdvpath="N" cdvlabel="" cdvrequired="N" resolution="INPUT"*/
/*   advanced="N" required="N" enable="N" type="BASEPATH" tabname="Parameters">*/
...
/*   processid="P11" required="N" resolution="INPUT" enable="N" type="LOGFILE">*/
/*  </parameter>*/
...
/*   processid="P11" required="N" resolution="INPUT" enable="N" type="LSTFILE">*/
/*  </parameter>*/
...
/*   processid="P11" required="N" resolution="INPUT" enable="N" type="PARMFILE">*/
/*  </parameter>*/
...
/*   processid="P11" required="N" resolution="INPUT" enable="N" type="PGMFILE">*/
/*  </parameter>*/
...
/*   tabname="Parameters" processid="P11" type="TEXT">*/
/*  </parameter>*/
...
/*   processid="P11" type="TEXT">*/
/*  </parameter>*/
/*  <parameter obfuscate="N" id="ARCMETA" canlinktobasepath="Y" expandfiletypes="N" protect="N" label="Folder" order="11" processid="P11" dependsaction="ENABLE" baseoption="A" resolution="INPUT" advanced="N" required="N" readfiles="Y" enable="N"*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter obfuscate="N" id="LUM_PATH" canlinktobasepath="Y" expandfiletypes="N" protect="N" label="Folder" order="12" processid="P11" dependsaction="ENABLE" baseoption="A" resolution="INPUT" advanced="N" required="N" readfiles="Y" enable="N"*/
/*   type="FOLDER" base="BASE_1" writefiles="N" tabname="Parameters">*/
/*   <fileset setType="0">*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter tabname="Parameters" id="BUM_PATH" expandfiletypes="N" obfuscate="N" label="Folder" required="N" order="13" baseoption="A" processid="P11" type="FOLDER" enable="N" canlinktobasepath="Y" readfiles="Y" protect="N" advanced="N"*/
...
/*   processid="P11" type="TEXT">*/
/*  </parameter>*/
/*  <parameter filetype="SAS" tabname="Parameters" id="FORMAT_RHAT" writefile="Y" obfuscate="N" label="Input file" required="N" order="20" baseoption="A" processid="P11" type="INFILE" enable="N" canlinktobasepath="Y" protect="N" advanced="N"*/
...
/*   processid="P11" type="TEXT">*/
/*  </parameter>*/
/*  <parameter obfuscate="N" id="RPTLIB" canlinktobasepath="Y" expandfiletypes="N" protect="N" label="Folder" order="24" processid="P11" baseoption="A" resolution="INPUT" advanced="N" required="N" readfiles="Y" enable="N" type="FOLDER" base="BASE_1"*/
/*   tabname="Parameters" writefiles="Y">*/
/*   <fileset setType="0">*/
...
/*   </description>*/
/*  </parameter>*/
/*  <parameter obfuscate="N" id="RPTLIBV" canlinktobasepath="Y" expandfiletypes="N" protect="N" label="Folder" order="25" processid="P11" dependsaction="ENABLE" baseoption="A" resolution="INPUT" advanced="N" required="N" readfiles="Y" enable="N"*/
/*   type="FOLDER" base="BASE_1" writefiles="Y" tabname="Parameters">*/
/*   <fileset setType="0">*/
/*    <sourceContainer system="RELATIVE" source="RELATIVE" displaypath="intrm1/programs_stat" displayname="replica_programs" id="intrm1/programs_stat/replica_programs" itemtype="Container" fileinfoversion="3.0">*/
/*    </sourceContainer>*/
/*    <filterList>*/
/*     <item name="ALL">*/
/*     </item>*/
