...
data _null_;
   ...
   %if %index(&rpt_name,_v) ge 1 or %index(&rpt_name,v_) ge 1 %then %do;
   fotnot&prp_j="Program Location: &sep.&sep.&dir_root.&sep.&dev_phase.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.&pgm_dir.&sep.replica_programs&sep.&rpt_pgm..&pgm_type";
   fotnot&prp_2j="Output Location: &sep.&sep.&dir_root.&sep.&dev_phase.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.&pgm_dir.&sep.replica_programs&sep.&rpt_name..&rpt_type";	
   fotnot&prp_3j="Dataset Location: &sep.&sep.&dir_root.&sep.&dev_phase2.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.data&sep.shared&sep.ads";
   %end;
   %else %do;
   fotnot&prp_j="Program Location: &sep.&sep.&dir_root.&sep.&dev_phase.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.&pgm_dir.&sep.&rpt_pgm..&pgm_type";
   fotnot&prp_2j="Output Location: &sep.&sep.&dir_root.&sep.&dev_phase.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.&pgm_dir.&sep.tfl_output&sep.&rpt_name..&rpt_type";	
   fotnot&prp_3j="Dataset Location: &sep.&sep.&dir_root.&sep.&dev_phase2.&sep.&compound.&sep.&study.&sep.&analy_phase.&sep.data&sep.shared&sep.ads";
   %end;
...
/*   %if %upcase(%nrbquote(&sysscp)) = WIN %then %do;*/
/*   %let prp_tmpfile=&drive_root&sep&dir_root&sep&dev_phase&sep&compound&sep&study&sep&analy_phase&sep&pgm_dir&sep.tfl_output&sep%lowcase(%sysfunc(compress(&rpt_name..&rpt_type)));*/
/*   %end;*/
/*   %else %do;*/
...
/*<process sessionid="-641f514d:1420bf0ad4c:-3717" sddversion="3.5" cdvoption="N" parseroption="B">*/
/* <parameters>*/
...
/*   tabname="Parameters" processid="P13" type="TEXT">*/
/*  </parameter>*/
...
/*   processid="P13" type="TEXT">*/
/*  </parameter>*/
/*  <parameter label="Text field" protect="N" obfuscate="N" cdvenable="Y" order="40" cdvrequired="Y" enable="Y" resolution="INPUT" required="Y" canlinktobasepath="N" advanced="N" dependsaction="ENABLE" id="DEV_PHASE2" maxlength="256"*/
/*   tabname="Parameters" processid="P13" type="TEXT">*/
/*  </parameter>*/
/* </parameters>*/
/*</process>*/
