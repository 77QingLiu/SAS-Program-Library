%macro AWE_initlilly_setup(phase2=qa,ref=TDTM,PorV=programs_nonsdd);
...
/*  libname arcmeta "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\arc_reporting_metadata"; /*location of arc tool metadata*/*/
  ...
  %if %sysfunc(fileexist(&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\sdtm)) %then libname sdtm "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\sdtm" access=readonly;;
  %if %sysfunc(fileexist(&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\adam)) %then libname adam "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\adam" access=readonly;;
  %if %sysfunc(fileexist(&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\ads)) %then libname ads "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\ads" access=readonly;;
  %if %sysfunc(fileexist(&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\eds)) %then libname eds "&drive_root\&dir_root\&dev_phase\&compound\&study\&analy_phase\data\shared\eds" access=readonly;;
