...
data plotZoneCount;
  ...
  if last then do;
    ...
    xl=20; yl=20; label='A'; low=xl-d1; high=xl+d1; size=10; zone='A'; output;
    xl=20; yl=120; label='D'; low=xl-d1; high=xl+d1; size=10; zone='D'; output;
    xl=20; yl=300; label='E'; low=xl-d1; high=xl+d1; size=10; zone='E'; output;
    xl=100; yl=20; label='B'; low=xl-d1; high=xl+d1; size=10; zone='B'; output;
    xl=170; yl=20; label='C'; low=xl-d1; high=xl+d1; size=10; zone='C'; output;
    xl=100; yl=160; label='B'; low=xl-d1; high=xl+d1; size=10; zone='B'; output;
...
ods graphics / reset width=5in height=3in antialiasmax=5700 imagename="4_12_1_Clark_Error_Grid_AtMap_SG_V94";
...
ods graphics / reset width=5in height=3in imagename="4_12_2_Clark_Error_Grid_Journal_SG_V94";
title 'Clark Error Grid for Blood Glucose';
proc sgplot data=plotZoneCount noautolegend /*dattrmap=attrmap*/;
  styleattrs datasymbols=(trianglefilled circlefilled squarefilled diamondfilled 
                          triangledownfilled);
  ...
  text x=xl y=yl text=label / backfill fillattrs=(color=white) outline contributeoffsets=none;
  xaxis min=0 max=400 offsetmin=0 offsetmax=0 label='Reference Blood Glucose';
  yaxis min=0 max=400 offsetmin=0 offsetmax=0 label='Sensor Blood Glucose';
  run;
